        ...
        <div className="flex-1 pl-[10px]">
          <div className="flex w-full items-center">
            <h2 className="uppercase text-[6vw] md:text-[2.5vw] leading-none md:leading-none font-bold flex mb-0 pb-0 relative overflow-hidden w-full">
              <span className="block transition-transform ease-in-out duration-[350ms] group-hover:translate-y-[-100%]">{heading}</span>
              <span className="absolute inset-0 transition-translate ease-in-out duration-[350ms] translate-y-full group-hover:translate-y-0 flex items-start">
