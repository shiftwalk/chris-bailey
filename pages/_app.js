...
export default function App({ Component, pageProps }) {
  ...
  if (router.asPath == '/') {
    bodyColor = 'bg-[#e7e8de] selection:bg-black selection:text-[#e7e8de]'
              ...
              <Div100vh className="fixed inset-0 z-[1000] flex flex-wrap items-end">
                ...
                >
                  <m.div 
                    ...
                    className="bg-[#6F808A] absolute inset-0 z-[1000] flex flex-wrap items-end w-full h-full p-[10px] cursor-wait"
                  >
